import { MailTrap } from "../../providers/mail/implementations/mailstrap.provider";
...
const sendMailNewUserController = new SendMailNewUserController(
  sendMailNewUserApplication
);
